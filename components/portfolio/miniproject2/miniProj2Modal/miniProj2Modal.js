...
import Mini2Contributor from '@/components/contributors/mini2contributor';
import styles from '@/components/portfolio/projectModal.module.css'

const MiniProj2Modal = ({ open, onClose }) => {
    return (
        <>
          {open && (
